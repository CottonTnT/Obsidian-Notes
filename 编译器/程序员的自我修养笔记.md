...
#### 3.2.7.1 符号 (Symble Table,链接的接口)

> 在链接中，函数和变量统称为_符号_，函数名或变量名为_符号名_。

- 每个. o 文件都有自己的符号表(Symbol table), 记录了. o 文件用到的所有符号
    
- 整个链接过程是基于符号完成的
    
- 每个定义的符号有一个对应的_符号值_，对于变量和函数说，_符号值就是他们的地址_
    
- **符号的类型**
    

![Pasted image 20230723144243.png](app://b3af12502d3e4c76dd4f895af594af3aa180/D:/Obsidian-Notes/images/Pasted%20image%2020230723144243.png?1705912816013)
...
![Pasted image 20230809101744.png](app://b3af12502d3e4c76dd4f895af594af3aa180/D:/Obsidian-Notes/images/Pasted%20image%2020230809101744.png?1705912816063)

**符号类型和绑定信息 (st_info )**：低 4 位表示符号的类型，高 28 位表示符号绑定信息，如下图

![Pasted image 20230723145356.png](app://b3af12502d3e4c76dd4f895af594af3aa180/D:/Obsidian-Notes/images/Pasted%20image%2020230723145356.png?1705912816018)

- **符号所在段 (st_shndx)**: ![Pasted image 20230723145829.png](app://b3af12502d3e4c76dd4f895af594af3aa180/D:/Obsidian-Notes/images/Pasted%20image%2020230723145829.png?1705912816018)
    
- **符号值 (st_value)**: ![Pasted image 20230723145941.png](app://b3af12502d3e4c76dd4f895af594af3aa180/D:/Obsidian-Notes/images/Pasted%20image%2020230723145941.png?1705912816023)
...
我们可以在程序中使用这些符号, 一些代表性的特殊符号如下 ![Pasted image 20230723150311.png](app://b3af12502d3e4c76dd4f895af594af3aa180/D:/Obsidian-Notes/images/Pasted%20image%2020230723150311.png?1705912816025) ![Pasted image 20230809104701.png](app://b3af12502d3e4c76dd4f895af594af3aa180/D:/Obsidian-Notes/images/Pasted%20image%2020230809104701.png?1705912816063)
...
- 编译器及链接器在处理符号时，适用某种名称修饰的方法，使得每个函数签名对应一个_修饰后名称_(decorated name),即C++源代码编译后的目标文件中所使用的符号名是相应的函数和变量的修饰后名称。
...
![Pasted image 20230723152125.png](app://b3af12502d3e4c76dd4f895af594af3aa180/D:/Obsidian-Notes/images/Pasted%20image%2020230723152125.png?1705912816026)

- 该机制同样应用于 C++中的全局变量与静态变量，_但变量的类型如同函数的返回值一样没有加入到 decorated name 中_
...
1 由于不同的编译器采用的不同的名称修饰方法，故不同编译器编译产生的目标文件无法正常相互链接
...
![Pasted image 20230723154708.png](app://b3af12502d3e4c76dd4f895af594af3aa180/D:/Obsidian-Notes/images/Pasted%20image%2020230723154708.png?1705912816026)
...
- 常见字符串表的段名为`strtab` 和 `shstrtab`,分别表示 *字符串表(String Table)*  和 *段表字符串表(Section Header String Table)*
	- 字符串表用来保存普通的字符串
	- 段表字符串表用来保存段表用到的字符串，常见如段名(sh_name)
...
通常这种做法，在ELF文件中中引用字符串只须给出一个数字下标即可，不用考虑字符串长度问题
